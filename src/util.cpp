...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\XYLO
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\XYLO
    // Mac: ~/Library/Application Support/XYLO
    // Unix: ~/.XYLO
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "XYLO";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "XYLO.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "XYLOd.pid"));
