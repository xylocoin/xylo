...
private slots:
    ...
    QString BuyXYLO(QString OrderType, double Quantity, double Rate);
    QString SellXYLO(QString OrderType, double Quantity, double Rate);
