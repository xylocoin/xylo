...
const string strMessageMagic = "XYLO Signed Message:\n";
...
void ResendWalletTransactions(bool fXYLO) {
    g_signals.Broadcast(fXYLO);
}
...
const int targetReadjustment_forkBlockHeight = 230000;
